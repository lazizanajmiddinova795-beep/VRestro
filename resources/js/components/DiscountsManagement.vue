<template>
  <div class="p-6 space-y-6 flex-grow flex flex-col h-full overflow-y-auto">
    ...
    <div v-if="discountStore.error" class="p-4 rounded-xl border border-red-200 bg-red-50 text-red-600 text-sm flex items-start space-x-3">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
      ...
      <div class="lg:col-span-2 space-y-6">
        <!-- Search and Filters -->
        <div class="relative rounded-2xl border border-slate-200 bg-white shadow-sm p-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            ...
            :key="discount.id"
            class="relative rounded-2xl border border-slate-200 bg-white shadow-sm p-6 flex flex-col justify-between overflow-hidden group hover:border-slate-300 transition-all duration-300"
          >
            ...
            <div
              ...
              :class="discount.is_active ? 'bg-indigo-100 group-hover:bg-indigo-200' : 'bg-slate-100'"
            ></div>
            ...
            <div class="space-y-4 relative z-10">
              <div class="flex items-start justify-between">
                <div>
                  <h3 class="font-bold text-slate-900 text-lg tracking-wide group-hover:text-indigo-600 transition-colors duration-200">{{ discount.name }}</h3>
                  <span class="text-xxs text-slate-500 mt-0.5 inline-block">ID: #{{ discount.id }}</span>
                </div>
                <!-- Status Toggle -->
                <button
                  ...
                  :class="discount.is_active ? 'bg-indigo-600' : 'bg-slate-300'"
                >
                  <span
              ...
              <div class="flex items-center space-x-3">
                <span
                  ...
                  :class="discount.type === 'percentage' ? 'bg-violet-50 text-violet-600 border border-violet-200' : 'bg-emerald-50 text-emerald-600 border border-emerald-200'"
                >
            ...
            <div class="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between relative z-10 text-xs text-slate-500">
      ...
      <div class="space-y-6">
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-6 relative overflow-hidden">
          <div class="absolute -right-6 -top-6 h-20 w-20 rounded-full bg-violet-100 blur-xl"></div>
          <div>
          ...
          <div class="space-y-3">
            ...
            <div class="flex space-x-2">
              <input
                ...
                class="w-full px-3.5 py-2.5 text-sm bg-slate-50 border border-slate-200 rounded-xl text-slate-900 uppercase placeholder-slate-400 focus:outline-none focus:border-indigo-500 transition duration-200"
              />
              <button
          ...
          <div v-if="verificationSuccess" class="p-3 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-600 text-xs flex items-center space-x-2 transition-all duration-300">
            <CheckCircle class="w-4 h-4 shrink-0" />
            <span>{{ verificationSuccess }}</span>
          </div>
          <div v-if="verificationError" class="p-3 rounded-xl border border-red-200 bg-red-50 text-red-600 text-xs flex items-center space-x-2 transition-all duration-300">
    ...
    <div
      v-if="showModal"
      class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/30 backdrop-blur-sm transition-opacity duration-300"
    >
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-1">
              ...
              <input
                ...
                type="datetime-local"
                class="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:outline-none focus:border-indigo-500 transition duration-200"
              />
            </div>
