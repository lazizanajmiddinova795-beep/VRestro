<template>
  <div class="p-6 space-y-6 flex-grow flex flex-col h-full overflow-y-auto relative">
    ...
    <div class="max-w-4xl flex-grow pb-24">
      ...
      <div v-if="activeTab === 'general'" class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fadeIn">
...
import { Save, UploadCloud, Loader2, KeyRound, Trash2, Send } from 'lucide-vue-next';
